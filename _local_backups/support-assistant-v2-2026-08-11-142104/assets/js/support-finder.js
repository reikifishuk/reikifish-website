        ...
        const nearbyCards = search.results.length
            ...
            : `
                <div class="sf-no-directory-results">
                    <h3>No high-confidence nearby listings were found</h3>
                    <p>
                        This does not mean that support is unavailable.
                        Nearby directory coverage varies between services and
                        locations. Use the verified professional directories below and confirm
    ...
    function renderOfficialRoutes(search) {
        ...
        return `
            <section class="sf-official-routes">
                ...
                <p>
                    Nearby map listings can be incomplete. These established
                    directories provide another route to qualified or regulated
                    support.
                </p>
