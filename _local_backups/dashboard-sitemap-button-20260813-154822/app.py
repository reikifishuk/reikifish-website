...
# RF_EDITOR_SITEMAP_ROUTE_START
from pathlib import Path as _RfPath
from sitemap_publisher import register_sitemap_routes as _rf_register_sitemap_routes
_rf_register_sitemap_routes(app, _RfPath(__file__).resolve().parents[1])
# RF_EDITOR_SITEMAP_ROUTE_END
