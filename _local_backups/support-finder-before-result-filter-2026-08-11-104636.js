...
document.addEventListener("DOMContentLoaded", function () {
    ...
    async function findNearbyPlaces(latitude, longitude, category) {
        const radius = category === "urgent" ? 30000 : 25000;
        const around =
            "(around:" +
            radius +
            "," +
        ...
        resultsContent.innerHTML = `
            ...
            <div class="sf-results-summary">
                ...
                <div class="sf-results-radius">
                    ...
                    <strong>${search.category === "urgent" ? "30 km" : "25 km"}</strong>
                </div>
            </div>
    ...
    function renderLookupError(search, error) {
        ...
        resultsContent.innerHTML = `
            ...
            <div class="sf-directory-error">
                <h3>The live directory could not respond</h3>
                <p>${escapeHtml(error.message)}</p>
                <p>
                    Public directory services can occasionally be busy.
                    Wait briefly and try again, or use the direct search below.
                </p>
                ...
                <div class="sf-error-actions">
                    ...
                    <a
                        href="${escapeAttribute(directSearch)}"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
