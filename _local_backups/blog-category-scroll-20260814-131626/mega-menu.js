...
(function () {
  ...
  var menuData = {
    ...
    blog: {
      ...
      links: [
        ['Latest articles', '/blog.html'],
        ['Updates', '/blog.html?category=Updates'],
        ['Psychology', '/blog.html?category=Psychology'],
        ['Reiki', '/blog.html?category=Reiki'],
        ['Events', '/blog.html?category=Events'],
        ['Coaching', '/blog.html?category=Coaching'],
        [
          'Parental Alienation & DARVO',
          '/blog.html?category=Parental%20Alienation%20%26%20DARVO'
        ],
        [
          'Social Science',
          '/blog.html?category=Social%20Science'
        ]
      ],
